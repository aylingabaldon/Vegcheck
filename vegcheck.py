...
with tabs[0]:
  ...
  st.write(f'<div style="text-align: justify;>Hay muchas maneras de adoptar un estilo de vida vegano. Sin embargo, algo que todos los veganos tienen en común es una dieta basada en plantas que evita todos los alimentos de origen animal, como la carne (incluidos el pescado, los mariscos y los insectos), los lácteos, los huevos y la miel ; además de evitar materiales derivados de animales, productos probados en animales y lugares que utilizan animales para el entretenimiento.</div>')
